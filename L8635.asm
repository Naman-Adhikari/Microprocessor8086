;LAB 10 PROGRAM 5
;Write a program to find the sum of the following series up to the terms specified by the
;user and display the result in decimal format. 2 × 4 + 3 × 6 + 4 × 8 +... to n terms.
...
L1:     MOV DL,[BX]     ;MOV CURRENT BYTE TO DL 
        ...
        ;GET SERIES  2x4 + 3x6 + 4x8 + ..... + 2(n+1)(n+1)
        ;formula to verify sum = [n(n+1)(2n+7)+6n]/3
L2:     INC CX
        MOV AX,CX
        MUL CX
        MUL TWO
