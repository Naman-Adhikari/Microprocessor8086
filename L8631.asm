;Write a program to find the sum of numbers from 1 to n. Read n from the user and display
;the sum in decimal format. (You can assume n as a single digit at first and you can modify
;it to read n as a 3-digit integer).
...
.DATA
    ...
    PROMPT2 DB 10,"Sum of given number upto n digits is: $"
    TEN DB 10
    BCD DB 6 DUP ('?')
